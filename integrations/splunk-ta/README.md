...
1. Download the latest release from [GitHub Releases](https://github.com/darkstrata/darkstrata-sdks/releases?q=splunk-ta)
...
1. Download the Splunk TA package from [GitHub Releases](https://github.com/darkstrata/darkstrata-sdks/releases?q=splunk-ta)
